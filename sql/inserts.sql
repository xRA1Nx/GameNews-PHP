...
"скоро появится   анимационный сериал от студии
Carbot Animations по мативам Diablol 2!",
"Уже в октябре 2022г. выйдет свет долгожданный нимационный сериал Diablol 2  от студии Carbot Animations, эпизоды которого посвящены забавным ситуациям, героям и боссам, непростым взаимоотношениям персонажей и разным механикам второй части игр серии Diablo."
);
